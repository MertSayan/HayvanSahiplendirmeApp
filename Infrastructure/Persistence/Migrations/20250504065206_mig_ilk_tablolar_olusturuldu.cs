...
{
    /// <inheritdoc />
    public partial class mig_ilk_tablolar_olusturuldu : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdoptionRequests_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PetCommentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PetId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetComments", x => x.PetCommentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PetLikeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PetId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetLikes", x => x.PetLikeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "AdoptionTrackings",
                columns: table => new
                {
                    AdoptionTrackingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AdoptionRequestId = table.Column<int>(type: "int", nullable: false),
                    WeekNumber = table.Column<int>(type: "int", nullable: false),
                    PhotoImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdoptionTrackings", x => x.AdoptionTrackingId);
                    table.ForeignKey(
                        name: "FK_AdoptionTrackings_AdoptionRequests_AdoptionRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdoptionRequests_SenderId",
                table: "AdoptionRequests",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "IX_AdoptionTrackings_AdoptionRequestId",
